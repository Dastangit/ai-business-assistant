    ...
    <div className="theme-light">
      ...
      <section style={{ padding: '6rem 5%' }}>
        <h2 style={{ textAlign: 'center', fontSize: '2.5rem', marginBottom: '5rem', color: 'var(--ink)' }}>
          Más que una <span className="accent-light">web bonita</span>
        </h2>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          ...
          <div className="feature-row">
            ...
            <div>
              ...
              <p style={{ color: 'var(--ink-2)', lineHeight: '1.6' }}>Estructuramos el código y el contenido para que Google y los asistentes de IA entiendan qué ofreces, dónde y a qué precio: la base para que te encuentren y te recomienden.</p>
            </div>
          </div>
