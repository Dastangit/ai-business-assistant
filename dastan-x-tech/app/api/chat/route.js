...
function construirPrompt(couponApplied) {
  ...
  const lineaPrecios = couponApplied
    ...
    : `Precios de partida (así aparecen en la web): Auditoría de Negocio 360° desde ${p.auditoria} USD, Diseño web (Cazador de Webs) desde ${p.web} USD, Posicionamiento AEO desde ${p.aeo} USD. El precio final depende del negocio y se confirma antes de empezar. Instagram a Web no tiene precio publicado: para eso, que escriba por WhatsApp. Nunca menciones cupones ni descuentos.`;
