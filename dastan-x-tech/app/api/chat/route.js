...
// Dónde se pide el diagnóstico en cada página (lo decide GlobalChatWidget): en las páginas de servicio el chat no tiene ese botón
const DIAGNOSTICO = {
  chat: {
    como: 'que pulse el botón "Pedir mi diagnóstico SEO gratis" de este chat',
    invitacion: 'con el botón del chat',
  },
  final: {
    ...
    invitacion: 'con el botón del final de esta página',
  },
  whatsapp: {
...
6. Cuando la persona muestre interés, invítala a pedir el diagnóstico SEO gratis ${d.invitacion}.
